      ...
      <div className="container mx-auto px-4 py-8">
        <Card className="max-w-2xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              Describe the ad you want, and Veo 3.1 will generate it for you. For your own reference photos
              (screenshots, fighter shots, etc.), use a <a href="/studios" className="text-primary hover:underline">Studio</a> instead.
            </CardDescription>
          </CardHeader>
          <CardContent>
